...
const SearchBar = ({ onSearch }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="relative group w-full max-w-md mx-auto mb-8">
            <div className="flex items-center bg-white/40 backdrop-blur-xl border border-white/40 rounded-2xl shadow-xl transition-all duration-300 focus-within:shadow-2xl focus-within:bg-white/50 focus-within:ring-2 focus-within:ring-blue-400/50">
                ...
                <button type="submit" className="mr-2 bg-blue-600/80 hover:bg-blue-600 text-white px-6 py-2 rounded-xl transition-all duration-300 active:scale-95 font-bold shadow-md hover:shadow-blue-500/50">
                    بحث
                </button>
            </div>
